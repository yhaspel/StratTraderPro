...
| [BUG-009](BUG-009-all-alert-rules-imported-paused.md) | **Every imported alert rule was PAUSED — the M10 alerting stack had never been able to fire** | **S1** | FIXED (every imported rule un-paused; the live rule count is tracked by ADR-109, not pinned here) | Alerting |
