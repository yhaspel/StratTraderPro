 ...
 * AuthFacade.loadGoogleAvailability) — an unconfigured deploy must not offer a
 * button that dead-ends on the backend's `503 FEATURE_DISABLED`. Click triggers
 * facade.startGoogleSignIn(), a top-level navigation to the backend /start/.
 */
...
export class GoogleButtonComponent implements OnInit {
  ...
  ngOnInit(): void {
    void this.facade.loadGoogleAvailability();
  }
